...
class DoctorScheduleResponseModel {
    ...
    factory DoctorScheduleResponseModel.fromMap(Map<String, dynamic> json) => DoctorScheduleResponseModel(
        ...
        data: json["data"] == null ? [] : List<DoctorSchedule>.from(json["data"]!.map((x) => DoctorSchedule.fromMap(x))),
...
class DoctorSchedule {
    ...
    factory DoctorSchedule.fromJson(String str) => DoctorSchedule.fromMap(json.decode(str));
